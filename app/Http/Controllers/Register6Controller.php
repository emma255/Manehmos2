...
class Register6Controller extends Controller
{
    ...
    public function store()
    {
        ...
        $this->validate(request(), [
            ...
            'Protenuria' => 'required_without_all:hana_matatizo,kuharibika_mimba_mfululizo,Anaemia,kutoongezeka_uzito,damu_ukeni,mlalo_mbaya_wa_mtoto,mimba_ya_nne+,kuzaa_kwa_operesheni,vacuum_extraction',
            'high_BP' => 'required_without_all:hana_matatizo,kuharibika_mimba_mfululizo,Anaemia,Protenuria,high_BP,damu_ukeni,mlalo_mbaya_wa_mtoto,mimba_ya_nne+,kuzaa_kwa_operesheni,vacuum_extraction',
            'kutoongezeka_uzito' => 'required_without_all:hana_matatizo,kuharibika_mimba_mfululizo,Anaemia,Protenuria,high_BP,kutoongezeka_uzito,mlalo_mbaya_wa_mtoto,mimba_ya_nne+,kuzaa_kwa_operesheni,vacuum_extraction',
            'damu_ukeni' => 'required_without_all:hana_matatizo,kuharibika_mimba_mfululizo,Anaemia,Protenuria,high_BP,kutoongezeka_uzito,damu_ukeni,mlalo_mbaya_wa_mtoto,mimba_ya_nne+,kuzaa_kwa_operesheni,vacuum_extraction',
