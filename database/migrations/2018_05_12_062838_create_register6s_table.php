...
class CreateRegister6sTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('register6s', function (Blueprint $table) {
            ...
            $table->string('kuharibika_mimba_mfululizo')->default('hapana');
            ...
            $table->string('mimba_ya_nne+')->default('hapana');
            $table->string('kuzaa_kwa_operesheni')->default('hapana');
            $table->string('vacuum_extraction')->default('hapana');
