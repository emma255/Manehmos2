...
class CreateRegister6sTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('register6s', function (Blueprint $table) {
            ...
            $table->string('mke_kipimo1_VVU',6)->nullable();
            ...
            $table->string('mrdt_o_bs',6);
            $table->string('llin',6);
            $table->string('ipt',6);
            $table->string('mke_kipimo_aina',6);
            $table->string('mume_kipimo_aina',6);
