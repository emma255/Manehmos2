...
<div class="container">
    <div class="row justify-content-center p-3 mb-2 bg-light text-black">
        ...
        <div>KARIBU {{ Auth::user()->name }},<br>Kwa kuanza kutumia Manehmos, bonyeza taarifa husika katika mwanzo. kurudi katika ukurasa huu, bonyeza kitufe cha mwanzo.<br>Kwa msaada zaidi wa matumizi ya mfumo nenda kwenye kitufe cha msaada.</div>
        <br>
            <div class="row">
               <div class="col-md-1">
            ...
            <div class="row">
               ...
               <div class="col-md-6">
               <label>MSAADA</label>
               <P>Kama kuna tatizo lolote katika mfumo huu hapa utapata msaada wa awali pamoja na namna ya kutumia mfumo huu</P>
               </div>
            ...
            <div class="row">
               ...
               <div class="col-md-6">
               <label><a class="btn btn-link" href="{{ route('password.request') }}">
