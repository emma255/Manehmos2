    ...
    <table id="customers">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$mimba = App\Models\RegisterMaternal::whereyear('tarehe_ya_kuandikishwa', request('year'))->wheremonth('tarehe_ya_kuandikishwa', request('month'))->where('mimba_ngapi', '>', '3')->count()}}</td>
                <td>{{$mimba}}</td>
            </tr>
            <tr>
                <td>3 b</td>
