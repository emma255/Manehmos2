...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{route('register6.store',['maternal'=>$maternal]) }}" method="post">
            @csrf
                            ...
                            <div class="col-md-12 card-body">
                                <div class="row">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input required type="text" name="namba_ya_usajili" class="form-control{{ $errors->has('namba_ya_usajili') ? ' is-invalid' : '' }}" value="{{ $maternal->namba_ya_usajili??'' }}" disabled>
                                    ...
                                    <div class="col-md-12 form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input required type="date" name="tarehe_ya_hudhurio" class="form-control{{ $errors->has('tarehe_ya_hudhurio') ? ' is-invalid' : '' }}"> @if ($errors->has('tarehe_ya_hudhurio'))
                                                <span class="invalid-feedback">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input required type="date" name="tarehe_ya_marudio" class="form-control{{ $errors->has('tarehe_ya_marudio') ? ' is-invalid' : '' }}"> @if ($errors->has('tarehe_ya_marudio'))
                                                <span class="invalid-feedback">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <input required type="date" name="tarehe_ya_TT" class="form-control{{ $errors->has('tarehe_ya_TT') ? ' is-invalid' : '' }}"> @if ($errors->has('tarehe_ya_TT'))
                                        <span class="invalid-feedback">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select required name="llin" class="form-control{{ $errors->has('llin') ? ' is-invalid' : '' }}">
                                            <option value="" hidden=""></option>
                                ...
                                <div class="row mt-1">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input required type="date" name="tarehe_ya_ipt" class="form-control{{ $errors->has('tarehe_ya_ipt') ? ' is-invalid' : '' }}"> @if ($errors->has('tarehe_ya_ipt'))
                                        <span class="invalid-feedback">
                        ...
                        <div class="col-md-12 card mt-1">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-3">
                                        <label>HB (g/dl)</label>
                                        <input required type="text" id="damu_HB" name="damu_HB" min="0" class="form-control{{ $errors->has('damu_HB') ? ' is-invalid' : '' }}"> @if ($errors->has('damu_HB'))
                                        <span class="invalid-feedback">
                                    ...
                                    <div class="col-md-4">
                                        <label>BP (mmHg)</label>
                                        <input required type="text" name="BP" min="0" class="form-control{{ $errors->has('BP') ? ' is-invalid' : '' }}"> @if ($errors->has('BP'))
                                        <span class="invalid-feedback">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        @if ($errors->has('sukari_kwenye_mkojo'))
                                        <span class="invalid-feedback">
                        ...
                        <div class="col-md-12 card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <input type="checkbox" value="ndio" name="hana_matatizo" class="form-control{{ $errors->has('hana_matatizo') ? ' is-invalid' : '' }}"> @if ($errors->has('hana_matatizo'))
                                        <span class="invalid-feedback">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <input type="checkbox" value="ndio" name="Anaemia" class="form-control{{ $errors->has('Anaemia') ? ' is-invalid' : '' }}"> @if ($errors->has('Anaemia'))
                                        <span class="invalid-feedback">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3"><input type="checkbox" value="ndio" name="Protenuria" class="form-control{{ $errors->has('Protenuria') ? ' is-invalid' : '' }}"> @if ($errors->has('Protenuria'))
                                        <span class="invalid-feedback">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <input type="checkbox" value="ndio" name="high_BP" class="form-control{{ $errors->has('high_BP') ? ' is-invalid' : '' }}"> @if ($errors->has('high_BP'))
                                        <span class="invalid-feedback">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <input type="checkbox" value="ndio" name="kutoongezeka_uzito" class="form-control{{ $errors->has('kutoongezeka_uzito') ? ' is-invalid' : '' }}"> @if ($errors->has('kutoongezeka_uzito'))
                                        <span class="invalid-feedback">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <input type="checkbox" value="ndio" name="damu_ukeni" class="form-control{{ $errors->has('damu_ukeni') ? ' is-invalid' : '' }}"> @if ($errors->has('damu_ukeni'))
                                        <span class="invalid-feedback">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3"><input type="checkbox" value="ndio" name="mlalo_mbaya_wa_mtoto" class="form-control{{ $errors->has('mlalo_mbaya_wa_mtoto') ? ' is-invalid' : '' }}"> @if ($errors->has('mlalo_mbaya_wa_mtoto'))
                                        <span class="invalid-feedback">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input required type="text" name="vidonge_vya_I_FA" min="0" class="form-control{{ $errors->has('vidonge_vya_I_FA') ? ' is-invalid' : '' }}"> @if ($errors->has('vidonge_vya_I_FA'))
                                        <span class="invalid-feedback">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @if ($errors->has('albendazole_mebendazole'))
                                        <span class="invalid-feedback">
                                ...
                                <table class="table table-sm table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if ($errors->has('mume_tayari_ana_VVU'))
                                            <span class="invalid-feedback">
                                        ...
                                        <td>
                                            ...
                                            @if ($errors->has('mke_tayari_ana_VVU'))
                                            <span class="invalid-feedback">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if ($errors->has('mume_amepima_VVU'))
                                            <span class="invalid-feedback">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if ($errors->has('mume_kipimo_aina'))
                                            <span class="invalid-feedback">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input required type="date" name="mume_tarehe_ya_kipimo" class="form-control{{ $errors->has('mume_tarehe_ya_kipimo') ? ' is-invalid' : '' }}"> @if ($errors->has('mume_tarehe_ya_kipimo'))
                                            <span class="invalid-feedback">
                                        ...
                                        <td>
                                            <input required type="date" name="mke_tarehe_ya_kipimo" class="form-control{{ $errors->has('mke_tarehe_ya_kipimo') ? ' is-invalid' : '' }}"> @if ($errors->has('mke_tarehe_ya_kipimo'))
                                            <span class="invalid-feedback">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if ($errors->has('mume_kipimo1_VVU'))
                                            <span class="invalid-feedback">
                                        ...
                                        <td>
                                            <select required name="mke_kipimo1_VVU" class="form-control{{ $errors->has('mke_kipimo1_VVU') ? ' is-invalid' : '' }}">
                                                <option value="" hidden=""></option>
                                                <option value="Positive">Positive</option>
                                                <option value="Negative">Negative</option>
                                            </select>
                                            @if ($errors->has('mke_kipimo1_VVU'))
                                            <span class="invalid-feedback">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if ($errors->has('mume_unasihi_baada_ya_kipimo_1'))
                                            <span class="invalid-feedback">
                                        ...
                                        <td>
                                            ...
                                            @if ($errors->has('mke_unasihi_baada_ya_kipimo_1'))
                                            <span class="invalid-feedback">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="row form-group">
                                        <div class="col-md-2"><label>Kipimo</label><label>Mume</label></div>
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            @if ($errors->has('matokeo_stds_mume'))
                                            <span class="invalid-feedback">
                                    ...
                                    <div class="row mt-1">
                                        <div class="col-md-2"><label>Kipimo</label><label>Mke</label></div>
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            @if ($errors->has('matokeo_stds_mke'))
                                            <span class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            @if ($errors->has('mume_ametibiwa_kaswende'))
                                            <span class="invalid-feedback">
                                    ...
                                    <div class="row mt-1">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            @if ($errors->has('mke_ametibiwa_kaswende'))
                                            <span class="invalid-feedback">
            ...
            <button required type="submit" class="btn btn-primary col-md-4 offset-4">hifadhi</button>
        </form>
    </div>
</div>
@endsection
