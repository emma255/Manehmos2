        		...
        		<form action="{{ ('register6/store') }}" method="post">
        			...
        			<div class="form-group">
        				...
        				<div class="row col-md-12">
        					...
        					<div class="col-md-2"><label>Namba ya usajili</label></div>

							<div class="col-md-2"><input type="text" class="form-control" name="rch_4_no"></div>

        					<div class="col-md-2"><label>Jina la mama</label></div>
							
							<div><input type="text" class="form-control" name="maternal_name"></div>
						</div>
							...
							<div class="col-md-4">
								...
								<div class="col-md-4 card">
									...
									<div class="card-body">
										...
										<div class="row">
											<div class="col-md-9"><label>Kuharibika mimba mfululizo x2+</label></div>
											<div class="col-md-3">
										...
										<div class="row">
											...
											<div class="col-md-3"
												><input type="checkbox" class"form-control" value="Protenuria" name="protenuria" >
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-md-3"
												><input type="checkbox" class"form-control" value="Mlalo mbaya wa mtoto" name="mlalo_mbaya">
											</div>
										</div>
										<div class="row">
											<div class="col-md-9"><label>Mimba ya nne kuendelea</label></div>
											<div class="col-md-3"
												><input type="checkbox" class"form-control" value="Mimba ya nne kuendelea" name="mimba_4+">
											</div>
										</div>
										<div class="row">
											<div class="col-md-9"><label>Kuzaa kwa operesheni</label></div>
											<div class="col-md-3"
												><input type="checkbox" class"form-control" value="Kuzaa kwa operesheni" name="c_s">
											</div>
										</div>
										<div class="row">
											<div class="col-md-9"><label>Vacuum extraction</label></div>
											<div class="col-md-3"
												><input type="checkbox" class"form-control" value="Vacuum extraction" name="ve">
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-md-5">
								...
								<div class="col-md-12 card">
									...
									<div class="card-body">
										<div class="row">
											<div class="col-md-6">
												<label>Idadi ya vidonge vya Iron (I), Folic Acid (FA)</label>
												<input type="number" name="ipt_3_number" class="form-control" min="0">
											</div>

											<div class="col-md-6">
												<label>Amepata Albendazole / Mebendazole</label>
												<select name="llin" class="form-control">
													<option value="" hidden=""></option>
													<option value="Ndiyo">Ndiyo</option>
													<option value="Hapana">Hapana</option>
								...
								<div class="row col-md-12">
									...
									<div class="col-md-5">
										<label>Maoni</label>
										<textarea name="Maoni" palceholder="Andika maoni hapa" class="form-control" rows="1" minlength="4"></textarea>
									</div>
						...
						<div class="col-md-12 card">
        						...
        						<div class="card-header"><p align="center">Rufaa</p></div>
