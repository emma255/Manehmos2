        				...
        				<div class="row">
		    					...
		    					<div class="row">
		    						...
		    						<div class="col-md-8">
					                    ...
					                    <div class="dropdown show dropdown-toggle-primary form-control">
					                      ...
					                      <div class="dropdown-menu form-control">
											  <div>
											  	<div class="row"><div class="col-md-10"><p><b>&nbsp;Iron/Folic Acid I, F, au IFA</b></p></div></div>
												<div class="row">
												...
												<br>
											  	...
											  	<div class="row"><div class="col-md-10"><p><b>&nbsp;Vitamin A</b></p></div></div>
												<div class="row">
													<div class="col-md-6"><label>&nbsp;Aina ya dawa</label></div>
        					...
        					<div class="col-md-6">
								...
								<div class="row">
									...
									<div class="col-md-7">
										    <textarea name="maoni" class="form-control" minlength="4" rows="1" placeholder="Andika maoni au sababu hapa" required></textarea>
									</div>
								</div>		    						
								</div>
