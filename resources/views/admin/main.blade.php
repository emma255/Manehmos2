@include('admin.head')
<body class="">
<div class="col-md-12 row bg-black" align="center"><h3>MATERNAL AND NEWBORN HEALTH MONITORING SYSTEM (Manehmos)</h3></div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-user-plus"></i> Create account</a></li>
